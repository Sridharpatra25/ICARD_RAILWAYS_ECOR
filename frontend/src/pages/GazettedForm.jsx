            ...
            <div className="bg-gray-100 rounded-lg p-4 max-h-64 overflow-y-auto border border-gray-200">
              ...
              {submittedData && submittedData._id && (
                <div className="mb-2 flex gap-4 items-center">
                  {submittedData.photo && (
                    <img src={`https://icard-railways-ecor.onrender.com/api/gazetted/photo/${submittedData._id}`} alt="Photo" style={{ width: 80, height: 100, objectFit: 'cover', borderRadius: 8, border: '1px solid #ccc' }} />
                  )}
                  {submittedData.signature && (
                    <img src={`https://icard-railways-ecor.onrender.com/api/gazetted/signature/${submittedData._id}`} alt="Signature" style={{ width: 100, height: 40, objectFit: 'contain', borderRadius: 8, border: '1px solid #ccc' }} />
                  )}
                </div>
              )}
